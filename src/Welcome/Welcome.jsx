...
const Welcome = () => {
    return (
        <>
            <header className="absolute bg-cinzaEscuro shadow-2xl shadow-black flex h-48 w-screen items-center justify-between font-mono">
            ...
            <div className="" >
                <a href="" className="pr-6 text-3xl text-5xl text-quaseBranco">Sobre os criadores</a>

        ...
        <div className="bg-cinzaEscuro min-h-screen flex items-center justify-center">
          <div className="w-full sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12">
            <div className="text-center">
              ...
              <div className="text-5xl mb-8 text-center text-quaseBranco">Faça seu cadastro</div>
            </div>
            ...
            <button className="bg-amareloPastel text-3xl font-bold font-mono my-4 w-full py-4 rounded-lg" type="submit">
              Conecte-se
            </button>

            <div className="flex flex-row justify-center mt-2">
              <h2 className="font-normal text-3xl text-quaseBranco">Já tem cadastro?</h2>
              <Link to={"/Login"} className="ml-2 text-3xl text-azulClaro hover:underline">
                Login
              </Link>
            </div>
          </div>
